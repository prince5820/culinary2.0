...
const Footer = ({
  ...
  return (
    <div className="footer float-left w-full">
      <div className="sm-desktop:relative sm-desktop:pb-5 sm-phone:p[40px_0_20px] float-left w-full overflow-hidden bg-[#b90435] p-[50px_0_40px]">
        <div className="relative mx-auto w-full max-w-[1570px] p-[0_15px]">
          <section className="float-left flex w-full flex-wrap p-0 xl:p-[0_50px]">
            <article className="emd-desktop:p-[0_15px] sm-desktop:mb-[25px] sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 sm-desktop:text-center sm-desktop:transition-all sm-desktop:duration-300 sm-desktop:ease-in-out sm-phone:mb-[10px] w-[24%] px-5 py-0 pl-0">
            ...
            <article className="emd-desktop:px-[15px] sm-desktop:m-0 sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 w-[19%] px-5">
              ...
              <div
                className="ease-[cubic-bezier(0.4,0,0.2,1)] sm-desktop:max-h-[500px] overflow-hidden transition-all duration-500"
                style={{
                  maxHeight: '500px',
            ...
            <article className="emd-desktop:px-[15px] sm-desktop:m-0 sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 w-[19%] px-5">
              ...
              >
                <ul className="sm-desktop:p-[15px_0] m-0 list-none p-0">
                  <li className="mb-[13px]">
                    <a
            ...
            <article className="emd-desktop:px-[15px] sm-desktop:m-0 sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 w-[19%] px-5">
              <h3 className="font-montserrat emd-desktop:text-base sm-desktop:cursor-pointer sm-desktop:py-[15px] relative m-[0_0_5px_0] pb-[10px] text-2xl font-semibold capitalize leading-[29.26px] text-white">
                Support
              </h3>
              <div
                className="ease-[cubic-bezier(0.4,0,0.2,1)] sm-desktop:max-h-[500px] overflow-hidden transition-all duration-500"
      ...
      <div className="float-left w-full bg-[#d1093f] p-[19px_0]">
        <div className="sm-desktop:flex-col relative mx-auto flex w-full max-w-[1570px] justify-between p-[0_15px]">
          <div className="elg-desktop:p-0 mb-phone:justify-center flex w-full flex-wrap justify-between p-[0px_50px]">
            <ul className="sm-desktop:justify-center mb-phone:flex-wrap mb-phone:gap-[5px_15px] flex gap-[15px]">
              <li className="font-montserrat sm-desktop:text-[12px] sm-desktop:font-medium list-none text-[14px] font-semibold leading-[17.07px] text-white">
                Developed by :
                <span>
            ...
            <ul className="sm-desktop:justify-center mb-phone:flex-wrap mb-phone:gap-[5px_15px] flex gap-[15px]">
              <li className="font-montserrat sm-desktop:text-center sm-desktop:text-[12px] sm-desktop:font-medium list-none text-[14px] font-semibold leading-[17.07px] text-white">
                Copyright © 1995 to 2025 Culinary Depot. All rights reserved.
              </li>
            </ul>
          </div>
        </div>
