...
const Footer = () => {
  ...
  return (
    <>
      <div className="w-full bg-[#b90435]">
        <footer className="container mx-auto w-full max-w-[1570px] px-4 py-10 text-white sm:px-[15px] lg:px-12 xl:px-20">
          {/* Grid layout for large screens */}
          <div className="hidden grid-cols-1 gap-8 md:grid-cols-2 min-[991px]:grid lg:grid-cols-5">
            {/* 1. Logo + Address */}
            ...
            <article className="footer_info_col emd-desktop:p-[0_15px] sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 sm-desktop:text-center sm-desktop:transition-all sm-desktop:duration-300 sm-desktop:ease-in-out relative flex flex-col flex-wrap justify-end border-none pl-0 pr-0 text-right">
          ...
          <div className="block min-[991px]:hidden">
            ...
            <article className="footer_info_col emd-desktop:p-[0_15px] sm-desktop:w-full sm-desktop:border-r-0 sm-desktop:p-0 sm-desktop:text-center sm-desktop:transition-all sm-desktop:duration-300 sm-desktop:ease-in-out relative mt-8 flex flex-col flex-wrap justify-end border-none pl-0 pr-0 text-right">
